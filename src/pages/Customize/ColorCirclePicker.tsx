  ...
  return (
    <div className={cl.container}>
      {colors.map((pair, index) => (
       ...
       <DeleteFilled style={{ fontSize: '20px', color: 'red', cursor: 'pointer', marginLeft: '5px' }}  onClick={() => {localStorage.removeItem('color'); localStorage.removeItem('headerColor'); window.location.reload()}} />
    </div>
  );
};
